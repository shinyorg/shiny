...
public class AndroidSqliteDatabase : SQLiteOpenHelper
{
    ...
    {
        db.ExecSQL($$"""
            CREATE TABLE motion_activity(
                Id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
                AutomotiveConfidence INTEGER NULL,
                CyclingConfidence INTEGER NULL,
                RunningConfidence INTEGER NULL,
                WalkingConfidence INTEGER NULL,
                StationaryConfidence INTEGER NULL,
                Timestamp INTEGER NOT NULL
            )
            """
        );
        db.ExecSQL("CREATE INDEX idx_motion_activity_timestamp ON motion_activity(Timestamp);");
    }

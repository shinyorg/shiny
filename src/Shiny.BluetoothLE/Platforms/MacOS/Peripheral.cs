...
public partial class Peripheral : CBPeripheralDelegate, IPeripheral
{
    ...
    void DoReconnect()
    {
        ...
        // Cancel any stale pending connection slot before re-issuing — CoreBluetooth holds
    ...
    // Time-windowed replay so a subscriber that hooks up immediately after Connect() still sees
    // the failure that connect produced.

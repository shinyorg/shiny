...
{
    public static AccessState GetAccessStatus(this Radio? radio)
    {
        if (radio == null)
        ...
        {
            RadioState.Disabled => AccessState.Disabled,
            RadioState.Off => AccessState.Disabled,
            RadioState.Unknown => AccessState.Unknown,
            _ => AccessState.Available
        };
    }

...
public static class Feature_Transactions
{
    ...
    //public static IObservable<BleWriteSegment> WriteBlobTransaction(this IPeripheral peripheral, string serviceUuid, string characteristicUuid, Stream stream) => Observable.Create<BleWriteSegment>(async (ob, ct) =>
    //{

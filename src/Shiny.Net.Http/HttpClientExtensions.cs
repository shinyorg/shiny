...
namespace Shiny.Net.Http
{
    ...
    {
        public static IObservable<HttpTransfer> Upload(HttpTransferRequest request) => Observable.Create<HttpTransfer>(ob =>
        {
        ...
        public static IObservable<HttpTransfer> Download(HttpTransferRequest request) => Observable.Create<HttpTransfer>(ob =>
        {
